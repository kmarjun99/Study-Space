...
export const AdBanner: React.FC<AdBannerProps> = ({ ad, variant = 'card', onClose, className = '' }) => {
  ...
  // ============================================================
  // BANNER VARIANT - Mobile & Desktop: Full banner
  // ============================================================
  if (variant === 'banner') {
    return (
      <>
        {/* MOBILE: Full-width banner (visible < md) - Like Blinkit */}
        <div
        ...
        >
          ...
          <div className="relative h-40 overflow-hidden">
            ...
            <div className="absolute top-2 left-2">
              <span className="inline-flex items-center gap-1 text-[9px] font-semibold text-white bg-indigo-600/90 backdrop-blur-sm px-2 py-1 rounded-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3">
              ...
              <button
                className="px-4 py-2 text-xs font-bold bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg flex items-center gap-1 shadow-lg"
