...
// Alias to avoid shadowing the local `imageUrl` prop on listing cards.
import { imageUrl as optimizeImage } from '../utils/imageUtils';
        ...
        >
            <div className="flex gap-4">
                ...
                <div className="w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden bg-gray-100">
                    {imageUrl ? (
                        <img src={optimizeImage(imageUrl, { w: 480, fmt: 'webp' })} alt={name} className="w-full h-full object-cover" loading="lazy" decoding="async" />
                    ) : (
