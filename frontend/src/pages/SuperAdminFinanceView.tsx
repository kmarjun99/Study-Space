...
export const SuperAdminFinanceView = () => {
    ...
    // Defer Recharts mount until after first paint — see AdminDashboard.tsx
    // for the rationale (Recharts measures container at mount-time before
    // Tailwind height classes resolve, logging width/-1 warnings).
